    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col s12">
                ...
                <form action="/ajouter/traitement" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary">Ajouter L'edutiant</button>
                    <br><br>
